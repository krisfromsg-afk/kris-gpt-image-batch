...
const LICENSE_SERVER = 'https://your-license-server.com/verify'; // ← đổi URL của bạn
const GET_KEY_URL    = 'https://your-shop.gumroad.com/l/yourproduct'; // ← đổi link bán key
...
async function activateLicense() {
  ...
  try {
    ...
    // Dev mode: allow any key containing "DEV-"
